...
RAG_VERIFICATION_PROMPT = """You are a cybersecurity fact-checker verifying article accuracy
against a knowledge base.

Compare the article below against the knowledge base context and identify:
1. Claims NOT supported by the knowledge base
2. Contradictions with the knowledge base
3. Missing key mitigations or framework references present in the context
...
- **RAG Fidelity Score**: [1-10]
- **Supported Claims**: [list key accurate claims, or "None identified"]
- **RAG Issues**: [unsupported or contradicted claims, or "None"]
